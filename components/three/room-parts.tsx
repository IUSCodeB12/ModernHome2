...
/** Warm-luxe room palette, shared by every geometry part. */
export const WALL = "#efe9e0"; // warm off-white
export const FLOOR = "#d8cdba"; // warm marble tile
export const CABINET = "#22201d"; // dark walnut lacquer
export const ACCENT = "#8a7a63";
export const BRASS = "#c9a24b";
export const WOOD = "#8a6a45";

export function LedCove() {
...
export function ShowcaseCabinet() {
  return (
